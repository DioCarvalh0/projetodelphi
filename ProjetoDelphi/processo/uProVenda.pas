...
uses
  ...
  RxToolEdit, RxCurrEdit, uEnum, cProVendas, System.ImageList, Vcl.ImgList;
...
begin
  inherited;
  grdListagem.Columns.SaveToFile('C:\Users\devmv\Documents\ProjetoDelphi\savegrid\grdVenda.cfg');
...
begin
  inherited;
  grdListagem.Columns.LoadFromFile('C:\Users\devmv\Documents\ProjetoDelphi\savegrid\grdVenda.cfg');
end;
