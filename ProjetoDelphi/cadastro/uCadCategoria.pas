...
uses
  ...
  cCadCategoria, uDTMConexao, uEnum, System.ImageList, Vcl.ImgList;
...
begin
  inherited;
  grdListagem.Columns.SaveToFile('C:\Users\devmv\Documents\ProjetoDelphi\savegrid\grdCategoria.cfg');
...
begin
  inherited; //se não quer executar a herança, comenta essa linha
...
begin
  inherited;
  grdListagem.Columns.LoadFromFile('C:\Users\devmv\Documents\ProjetoDelphi\savegrid\grdCategoria.cfg');
end;
