...
uses
  uCadCategoria, uCadCliente, uCadProduto, uProVenda, uRelCategoria, uRelCliente, uRelClienteFicha, uRelCadProduto, uRelCadProdutoGrupoCategoria, uSelecionarData, uRelVendaPorData, uCadUsuario, uLogin, uAlterarSenha, cAcaoAcesso, uCadAcaoAcesso, uUsuarioVsAcoes, uTelaHeranca, uCadSubCategoria;
